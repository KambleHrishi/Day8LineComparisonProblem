namespace Day8LineComparisonProblem
{
    ...
    public class Program
    {
        public static void Main(String[] args)
        {
            ...
            lc1.Calc(a, b, c, d);
            Console.WriteLine("Line1 Length is = " + lc1.length_Of_Line);
            ...
            //comparing both line values to if its equal Returns True if not equal then returns False
            Console.WriteLine("Checking lines are equal the answer is");
            Console.WriteLine((lc1.length_Of_Line).Equals(lc2.length_Of_Line));
            ...
            Console.WriteLine((lc1.length_Of_Line).CompareTo(lc2.length_Of_Line));
        }
